...
import { internalPlugin } from '@apollo/server/src/internalPlugin';
import { dateToProtoTimestamp, TraceTreeBuilder } from '@apollo/server/src/plugin/traceTreeBuilder';
import { defaultSendOperationsAsTrace } from '@apollo/server/src/plugin/usageReporting/defaultSendOperationsAsTrace';
import {
  createOperationDerivedDataCache,
  type OperationDerivedData,
  operationDerivedDataCacheKey,
} from '@apollo/server/src/plugin/usageReporting/operationDerivedDataCache';
import type {
  ApolloServerPluginUsageReportingOptions,
  SendValuesBaseOptions,
} from '@apollo/server/src/plugin/usageReporting/options';
import { OurReport } from '@apollo/server/src/plugin/usageReporting/stats';
import { makeTraceDetails } from '@apollo/server/src/plugin/usageReporting/traceDetails';
import { packageVersion } from '@apollo/server/src/generated/packageVersion';
import { computeCoreSchemaHash } from '@apollo/server/src/utils/computeCoreSchemaHash';
import type { HeaderMap } from '@apollo/server/src/utils/HeaderMap';
import { schemaIsSubgraph } from '@apollo/server/src/plugin/schemaIsSubgraph';
