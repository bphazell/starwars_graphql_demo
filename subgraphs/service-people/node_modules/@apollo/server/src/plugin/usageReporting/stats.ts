...
import { DurationHistogram } from '@apollo/server/src/plugin/usageReporting/durationHistogram';
import { iterateOverTrace, type ResponseNamePath } from '@apollo/server/src/plugin/usageReporting/iterateOverTrace';
