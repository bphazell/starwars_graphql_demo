...
import { newCachePolicy } from '@apollo/server/src/cachePolicy';
import { determineApolloConfig } from '@apollo/server/src/determineApolloConfig';
import {
  ensureError,
  ensureGraphQLError,
  normalizeAndFormatErrors,
} from '@apollo/server/src/errorNormalize';
import {
...
import { runPotentiallyBatchedHttpQuery } from '@apollo/server/src/httpBatching';
import { type InternalPluginId, pluginIsInternal } from '@apollo/server/src/internalPlugin';
import {
  preventCsrf,
  recommendedCsrfPreventionRequestHeaders,
} from '@apollo/server/src/preventCsrf';
import { APQ_CACHE_PREFIX, processGraphQLRequest } from '@apollo/server/src/requestPipeline';
import { newHTTPGraphQLHead, prettyJSONStringify } from '@apollo/server/src/runHttpQuery';
import { SchemaManager } from '@apollo/server/src/utils/schemaManager';
import { isDefined } from '@apollo/server/src/utils/isDefined';
import { UnreachableCaseError } from '@apollo/server/src/utils/UnreachableCaseError';
import { computeCoreSchemaHash } from '@apollo/server/src/utils/computeCoreSchemaHash';
import type { WithRequired } from '@apollo/utils.withrequired';
import type { ApolloServerOptionsWithStaticSchema } from '@apollo/server/src/externalTypes/constructor';
import type { GatewayExecutor } from '@apollo/server-gateway-interface';
import type { GraphQLExperimentalIncrementalExecutionResults } from '@apollo/server/src/incrementalDeliveryPolyfill';
import { HeaderMap } from '@apollo/server/src/utils/HeaderMap';
import type {
  ExecuteOperationOptions,
  VariableValues,
} from '@apollo/server/src/externalTypes/graphql';
