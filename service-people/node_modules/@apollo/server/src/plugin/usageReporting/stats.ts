...
import { DurationHistogram } from '@apollo/server/src/plugin/usageReporting/durationHistogram.js';
import { iterateOverTrace, type ResponseNamePath } from '@apollo/server/src/plugin/usageReporting/iterateOverTrace.js';
