...
import type { SendErrorsOptions } from '@apollo/server/src/plugin/usageReporting/index.js';
...
import type { ApolloServerPlugin } from '@apollo/server/src/externalTypes/index.js';
